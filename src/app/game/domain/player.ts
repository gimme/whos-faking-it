 ...
 */
export type SeatCount = 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9

export const ALL_SEAT_COUNTS: ReadonlyArray<SeatCount> = [2, 3, 4, 5, 6, 7, 8, 9] as const
export const MIN_SEAT_COUNT: SeatCount = ALL_SEAT_COUNTS[0]
